...
namespace EnglishWordsPlay
{
    public partial class Form1 : Form
    {
        ...
        /*"FALL","TRAP","DEVİL","MUD","DİSGRACE","EACHOTHER","FEAR","COURAGE","GRADUATED"
        ...
        ,"DRAWER","UPSTAİRS","UPTOWN","AMBUSH","CARRY ON","ACHİNG","MOTİON","LET"*/

        /*"DÜSMEK","TUZAK","SEYTAN","CAMUR","REZALET","BIRBIRLERI","KORKU","CESARET","MEZUN","YURT"
        ...
        "CEKMECE","YUKARIKAT","SEHİR DISI","PUSUYA DÜSÜRÜLMEK","DEVAM ETMEK","ACITIYOR","HAREKET","İZİN VERMEK"*/


        string[] words = {"traits" ,"curious", "efficient", "innovative", "ATTENTİON ",
        "THOROUGH","SEEKİNG", "candidates"," applicant","relevant ", "field","simultaneously",
          "employee","solution","Appreciate","individual","Balance","supervisor","impressive","previous","indicate" ,
          "structure","process","requirements","certain","adjust","conclusions","evaluation","experiment","expect"
        ,"purpose","Proven","incosistent","prefixes"," instance","customer","increase","amount","scale","indeed","prons",
        "cons","fluctuate","rise","decline","varios","correspond","descreases","Prediction","remarkable","obsolescence",};


        string[] mean = {"OZELLIKLER","MERAKLI", "VERIMLI","YENILIKCI","DIKKAT" , "KAPSAMLI",
        "ARANIYOR","ADAYLAR","BASVURU SAHİBİ","ILGILI","ALAN","AYNI ANDA","CALISAN","COZUM", "TEBRIK ETMEK"
        ,"BIREYSEL","DENGE","GOZETMEN","ETKILEYICI", "ONCESI","ISARET ETMEK","YAPI","İSLEM","İHTİYAC","KESIN","AYARLAMAK",
        "SONUC","DEGERLENDİRME","DENEY","BEKLENTI","AMAC","KANITLAMAK","TUTARSIZ", "ON EK","ORNEK","MUSTERI","ARTMA",
        "MIKTAR","OLCEK","ASLINDA","ARTILARI","EKSILERI","DALGALANMAK","YUKSELMEK","DUSUS","CESİTLİ","HABERLEYICI",
        "DUSUS","TAHMİN","DIKKAT CEKICI","MODASI GECME"};
        ...
        private void timer_Gerisayim_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dakika == 0)
                {
                    ...
                    MessageBox.Show("süre bitmiştir", "bilgilendirme", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    puan = 0;
                }
                else
                {
        ...
        {
            if (e.KeyCode == Keys.Enter) { Checked_btn_Click( sender,  e); }
        }
    }
}
